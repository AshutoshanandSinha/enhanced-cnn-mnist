...
class SimpleMNISTNet(nn.Module):
    def __init__(self):
        ...
        self.layer2 = self._conv_relu_bn(in_channels=8, out_channels=8, kernel_size=3)  # Output: [-1, 12, 24, 24] # Receptive field: 5
        self.layer3 = self._conv_relu_bn(in_channels=8, out_channels=12, kernel_size=3) # Output: [-1, 16, 24, 24] # Receptive field: 7
        self.layer4 = self._conv_relu_bn(in_channels=12, out_channels=12, kernel_size=3) # Output: [-1, 16, 24, 24] # Receptive field: 9

        self.pool = nn.MaxPool2d(2)  # Output: [-1, 16, 12, 12]  # Receptive field: 10

        self.layer5 = self._conv_relu_bn(in_channels=12, out_channels=8, kernel_size=3)  # Output: [-1, 10, 12, 12] # Receptive field: 14
        self.layer6 = self._conv_relu_bn(in_channels=8, out_channels=16, kernel_size=3)  # Output: [-1, 20, 12, 12] # Receptive field: 18
        self.layer7 = self._conv_relu_bn(in_channels=16, out_channels=12, kernel_size=3)  # Output: [-1, 16, 10, 10] # Receptive field: 22
        self.layer8 = self._conv_relu_bn(in_channels=12, out_channels=10, kernel_size=3)  # Output: [-1, 10, 8, 8]   # Receptive field: 26
